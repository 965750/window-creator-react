export default {
  en: {
    ...
    'Are You interested in this app? If You want to see full code with tests checkout my ': 'Are You interested in this app? If You want to see full code with tests checkout my ',
    'Github repository here': 'Github repository here',
    'Window\'s height must be between 260cm and 180cm, also for width it\'s 140cm and 70cm': 'Window\'s height must be between 260cm and 180cm, also for width it\'s 140cm and 70cm',
  ...
  pl: {
    ...
    'Are You interested in this app? If You want to see full code with tests checkout my ': 'Zainteresowała Cie aplikacja? Jeśli chcesz zobaczyć pełny kod razem z testami, sprawdź moje ',
    'Github repository here': 'repozytorium na Github\'ie tutaj',
    'Window\'s height must be between 260cm and 180cm, also for width it\'s 140cm and 70cm': 'Wysokość okna musi być pomiedzy 260cm i 180cm, a dla szerokości pomiędzy 140cm i 70cm',
